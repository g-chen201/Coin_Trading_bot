...
import ccxt
from Code.Trade import next_run_time, place_order, get_bitfinex_candle_data, auto_send_email, fetch_position, \
    send_dingding_msg, fetch_margin_balance
...
while True:
    ...
    # signal = 1  # 测试用
    print('\n交易信号', signal)
    send_dingding_msg('eth' + str(signal))
    # =====sell short
